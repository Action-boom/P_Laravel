        ...
        <div class="card">
            <form method="POST" action="{{ route('productos.store') }}">
                ...
                <div>
                    ...
                    <input type="text" id="nombre" name="nombre" placeholder="Ej: Laptop Dell XPS" required>
                </div>

                <div>
                    <label for="descripcion">Descripción</label>
                    <textarea id="descripcion" name="descripcion" placeholder="Describe los detalles del producto..."></textarea>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 2rem;">
                    <button type="submit" class="btn" style="flex: 1;">✓ Guardar Producto</button>
